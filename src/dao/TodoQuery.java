...
public class TodoQuery {
	...
	static {
		...
		SELECT_TODOLIST_BY_DATE = "SELECT todo_no todoNo, todo_date todoDate, member_id memberId ,todo_content todoContent, create_date createDate, update_date updateDate, font_color fontColor FROM todo WHERE todo_date=? AND member_id=?";
		INSERT_TODO = "INSERT todo(todo_date, todo_content, member_id, create_date, update_date, font_color) VALUES(?,?,?,NOW(),NOW(),?)";
